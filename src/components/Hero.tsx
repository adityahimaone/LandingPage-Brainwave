  ...
  return (
    ...
    >
      <div className="container relative" ref={parallaxRef}>
          ...
          <h1 className="h1 mb-6">
            ...
            <span className="relative inline-block">
              ...
              <img
                src={curve}
                alt="curve"
                className="left absolute left-0 top-full w-full xl:-mt-2"
                width={624}
                height={28}
              />
            </span>
        ...
        <div className="xl relative mx-auto max-w-[23rem] md:max-w-5xl xl:mb-24">
          <div className="relative z-1 rounded-xl bg-conic-gradient p-0.5">
            <div className="relative rounded-[1rem] bg-n-8">
              <div className="h-[1.4rem] rounded-t-[0.9rem] bg-n-10" />
              <div className="aspect-[33/40] overflow-hidden rounded-b-[0.9rem] md:aspect-[668/490] lg:aspect-[1024/490]">
                <img
                  src={robot}
          ...
          <div className="lg: absolute -top-[54%] left-1/2 w-[234%] -translate-x-1/2 md:-top-[46%] md:w-[138%] lg:-top-[104%]">
            <img
              src={heroBackground}
              className="w-full"
              width={1440}
        ...
        <CompanyLogo className="relative z-10 mt-20 hidden lg:block" />
      </div>
      <BottomLine />
    </Section>
  );
